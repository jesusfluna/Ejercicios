...
public class HomeController {
	...
	public String descargarTodo(Locale locale, Model model,@RequestParam("imagenes") String[] listacb) {
		logger.info("Welcome home! The client locale is {}.", locale);
		...
		if(listacb.length<1) {
			...
			zc.generateFileList(new File(rutaLocal));
			zc.zipIt(System.getProperty("user.home") + "/Desktop/");
