...
<table class="table table-hover">
  <thead>
    <tr align="center">
      ...
      <th scope="col"><spring:message code="message.link" /></th>
	...
	<c:set value="${requestScope.user}" var="user" />
  	...
  	<c:forEach items="${descargas}" var="item">
  		<tr align="center">
      		...
      		<td><img class="mb-4" src="resources/ojo.png" alt="alr" width="32" height="32" data-toggle="popover" data-content="${item.url}"></td>
      		<td>${item.name}</td>
      		<td>${item.owner}</td>
      		<td>			      	
				          ...
				          <div class="modal-dialog" role="document">
				            <div class="modal-content">
				              <div class="modal-header">
				                ...
				                <h5 class="modal-title"><spring:message code="message.delete" /></h5>
