	        ...
	        <div class="container">
	          <div class="row d-flex align-items-center">
	            <div class="col-md-6 d-md-block d-none">
	              ...
	              <p><spring:message code="message.intro" /></p>
	            </div>
	            <div class="col-md-6">
		...
		<c:when test="${error==2}">
			<div class="alert alert-success alert-dismissible fade show" role="alert" align="center">
				<button type="button" class="close" data-dismiss="alert" aria-label="Close">
		 	 	...
		 	 	<strong><spring:message code="message.success" />!!!</strong> ${message}
			</div>
		</c:when>
		<c:when test="${error==1}">
			...
			<div class="col-md-auto">
				  ...
				  <div class="card-body">
				    ...
				    <form:form action="logout" method="post">
				    	<button type="submit" class="btn btn-danger btn-block" name="btn"><spring:message code="message.logout" /></button>
				    </form:form>
				  </div>
				</div>
				...
				<form:form action="changeView" method="post" modelAttribute="changeView">
					...
					<div class="btn-group-vertical" style="width: 18rem;">
					 ...
					 <button type="submit" class="btn btn-success btn-block" name="btn" value="1"><spring:message code="message.mfile" /></button>
					 <button type="submit" class="btn btn-success btn-block" name="btn" value="2"><spring:message code="message.afile" /></button>
					 <button type="submit" class="btn btn-success btn-block" name="btn" value="3">
					 	<spring:message code="message.alr" />
					 	<span class="badge badge-warning">${numAlr}</span>
					 </button>
					</div>
				</form:form>
	    	</div>
