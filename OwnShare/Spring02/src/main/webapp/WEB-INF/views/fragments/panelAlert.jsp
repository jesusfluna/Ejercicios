...
<thead>
    <tr align="center">
      ...
      <th scope="col"><spring:message code="message.issue" /></th>
      <!--<th scope="col">Sender</th> -->
      <th scope="col"><spring:message code="message.sender" /></th>
      <!--<th scope="col">Agree</th> -->
      <th scope="col"><spring:message code="message.agree" /></th>
      <!--<th scope="col">Disagree</th> -->
      <th scope="col"><spring:message code="message.disagree" /></th>
    </tr>
  </thead>
  <tbody>
      		...
      		<td>			      	
	      		<form:form action="agree" method="post" modelAttribute="agree">
		      		...
		      		<div class="col-md-12 col-sm-12 text-section">
			      			...
			      			<button type="button" class="btn btn-sm btn-success btn-block" data-toggle="modal" data-target="#exampleModalButton"><spring:message code="message.agree" /></button>
				          ...
				          <div class="modal-dialog" role="document">
				            <div class="modal-content">
				              <div class="modal-header">
				                ...
				                <h5 class="modal-title"><spring:message code="message.agree" /></h5>
				              ...
				              <div class="modal-body">
				                ...
				                <p><spring:message code="message.magree" /><strong><spring:message code="message.sure" /></strong></p><p>
				              </p></div>
				              <div class="modal-footer">
				               ...
				               <!-- <button class="btn btn-success" type="submit" name ="btn" value="${item.id}">Continue</button>-->
				                <button class="btn btn-success" type="submit" name ="btn" value="${item.id}"><spring:message code="message.continue" /></button>
				              </div>
				            </div>
				          </div>
				        </div>
				            ...
				            <div class="modal-content">
				              <div class="modal-header">
				               <!-- <h5 class="modal-title">Disagree</h5> -->
				                <h5 class="modal-title"><spring:message code="message.disagree" /></h5>
				                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
				                  <span aria-hidden="false">×</span>
				                </button>
				              </div>
				              <div class="modal-body">
				                ...
				                <p><spring:message code="message.mdisagree" /><strong><spring:message code="message.sure" /></strong></p><p>
				              </p></div>
				              <div class="modal-footer">
				                <!--<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>-->
				                <button type="button" class="btn btn-secondary" data-dismiss="modal"><spring:message code="message.cancel" /></button>
