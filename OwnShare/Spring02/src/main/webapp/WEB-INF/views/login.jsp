			...
			<div class="col-md-auto">
				...
				<form:form action="changeView" method="post" modelAttribute="changeView">
					...
					<div class="btn-group-vertical" style="width: 18rem;">
					 ...
					 <button type="submit" class="btn btn-outline-success btn-block" name="btn" value="1"><spring:message code="message.mfile" /></button>
					 <!-- <button type="submit" class="btn btn-outline-success btn-block" name="btn" value="2">All Files</button>-->
					 <button type="submit" class="btn btn-outline-success btn-block" name="btn" value="2"><spring:message code="message.afile" /></button>
					 <!-- <button type="submit" class="btn btn-outline-success btn-block" name="btn" value="3">Alerts</button>-->
					 <button type="submit" class="btn btn-outline-success btn-block" name="btn" value="3"><spring:message code="message.alr" /></button>
					</div>
				</form:form>
	    	</div>
