...
public class HomeController {
	/**BBDD*/
	private String urlbd = "jdbc:postgresql://localhost:5432/INERCOWEB";
	private String usuario = "XXXXXX";
	private String contrasena = "XXXXXX";
	/**Inerco Owncloud webdav*/
	private String webdav = "XXXXXXXXXXXX";
...
//			model.addAttribute("message", "UPS!, Database connection error");
	...
	public String download(Locale locale,Model model,@RequestParam("id_user") String id_user,@RequestParam("id_down") String id_down) throws NumberFormatException, SQLException{
		...
		try {
			...
			model.addAttribute("user", usuario);
			model.addAttribute("error", "1");
			messageSource.getMessage("message.error4",null, locale);
//			model.addAttribute("message",  "UPS!, Incorrect file download from the server");
		...
		messageSource.getMessage("message.success1",null, locale);
//		model.addAttribute("message", "Succesful file download from the server.");
	...
	public String delete(Locale locale,Model model,@RequestParam("id_user") String id_user,@RequestParam("id_down") String id_down) throws NumberFormatException, SQLException{
		...
		try {
			...
			model.addAttribute("user", usuario);
			model.addAttribute("error", "1");
			messageSource.getMessage("message.error5",null, locale);
//			model.addAttribute("message",  "UPS!, we have a problem deleting the file.");
		...
		model.addAttribute("user", usuario);
		model.addAttribute("error", "2");
		messageSource.getMessage("message.success2",null, locale);
//		model.addAttribute("message", "File deleted from the server.");
	...
	public String newFile(Locale locale,Model model, @RequestParam("file") MultipartFile file, @RequestParam("id_user") String id_user) throws NumberFormatException, SQLException{
		...
		try {
			...
			model.addAttribute("user", usuario);
			model.addAttribute("error", "1");
			messageSource.getMessage("message.error6",null, locale);
//			model.addAttribute("message",  "UPS!, Incorrect file upload");
		...
		model.addAttribute("user", usuario);
		model.addAttribute("error", "2");
		messageSource.getMessage("message.succesf",null, locale);
...
//			model.addAttribute("message", "UPS!, The download alert was confirmed.");
		...
		model.addAttribute("error", "2");
		messageSource.getMessage("message.success3",null, locale);
//		model.addAttribute("message", "The alert was confirmed and the download was erased from the server..");
	...
	public String disagree(Locale locale,Model model, @RequestParam("id_alr") String id_alr, @RequestParam("id_user") String id_user) {
		...
		try {
			...
			model.addAttribute("error", "1");
			messageSource.getMessage("message.error8",null, locale);
//			model.addAttribute("message", "UPS!,The download alert can't be denied.");
			model.addAttribute("user", usuario);
		}

		model.addAttribute("error", "2");
		messageSource.getMessage("message.success4",null, locale);
//		model.addAttribute("message", "The alert was ignored and erased from the server."); 
	...
	public String newAlert(Locale locale,Model model, @RequestParam("id_down") String id_down, @RequestParam("id_user") String id_user, @RequestParam("comment") String comment) throws NumberFormatException, SQLException {
		...
		try {
			...
			model.addAttribute("descargas", descargas);
			model.addAttribute("error", "1");
			messageSource.getMessage("message.error9",null, locale);
//			model.addAttribute("message", "UPS!,There is a problem creating the alert.");
		...
		model.addAttribute("descargas", descargas);
		model.addAttribute("error", "2");
		messageSource.getMessage("message.success5",null, locale);
